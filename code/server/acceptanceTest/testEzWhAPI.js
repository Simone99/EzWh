...
function testFR() {
	let myuser = users.newCompleteUser(
		'user12@ezwh.com',
		'John',
		'Smith',
		'testpassword',
	...
	let mysupp = users.newCompleteUser(
		'supp1@ezwh.com',
		'supName',
		'supSur',
		'testpassword',
	...
	let myeditedskuToPut = skus.newSkuEdit(
		'skuedited',
		'noteedited',
		50,
		50,
	...
	let mypositions = [];
	mypositions[0] = positions.newPosition(
		'800134543412',
		'8001',
		'3454',
		'3412',
	...
	mypositions[1] = positions.newPosition(
		'800234553413',
		'8002',
		'3455',
		'3413',
	...
	let myrestocks = [];
	myrestocks[0] = restockorders.newRestockOrder(
		'2022/05/16 09:33',
		myproducts,
		0
	);
	myrestocks[1] = restockorders.newRestockOrder(
		'2022/05/17 19:00',
		myproducts,
		1
	);
	...
	myproductswithrfid[0] = returnorders.newProductwithRFID(
		myproducts[0],
		rfids[2]
	);
	myproductswithrfid[1] = returnorders.newProductwithRFID(
		myproducts[1],
		rfids[3]
	);

	let myreturnorders = [];
	myreturnorders[0] = returnorders.newReturnOrder(
		'2022/05/16 23:33',
		myproductswithrfid,
		0
	);
	myreturnorderwithnosuppid = returnorders.newReturnOrder(
		'2022/05/16 23:33',
		myproductswithrfid,
		100000
	);
	...
	describe('Testing Functional requirements', () => {
		...
		users.testEditUser(
			agent,
			{ oldType: 'customer', newType: 'clerk' },
			myuser.username,
			200
		);
		...
		positions.testEditPosition(
			agent,
			updateposition,
			mypositions[0].positionID,
			200
		);
		...
		positions.testEditPositionChangeID(
			agent,
			newpositionid,
			mypositions[1].positionID,
			200
		);
		skus.deleteAllSkus(agent);
		skus.testPostNewSku(agent, mysku[0], 201);

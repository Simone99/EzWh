...
describe("get return orders", () => {
    beforeEach(async() => {
        ...
        await DAO_test.addItem(new Item("a new item", 10.99, 1, 1, 1));
        await DAO_test.addRestockOrder("2021/11/29 09:33", [{"SKUId":1,"itemId":1,"description":"a new item","price":10.99,"qty":30}], 1);
        await DAO_test.addSKUItem(item1);
        await DAO_test.addReturnOrder(1, [{"SKUId":1,"itemId":1,"description":"a product","price":10.99,"RFID":"12345678901234567890123456789015"}], "2021/11/29 09:33");
    });
        ...
        expect(res).toEqual([
            {
                ...
                products: [{"SKUId":1,"itemId":1,"description":"a new sku","price":10, "RFID":"12345678901234567890123456789015"}],
                restockOrderId: 1
            }
        ]);
    });

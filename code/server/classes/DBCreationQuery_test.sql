...
CREATE TABLE IF NOT EXISTS RESTOCKORDERITEM_TABLE(
    ...
    PRICE INTEGER,
    QUANTITY INTEGER,
    PRIMARY KEY (ID_RESTOCKORDER, ITEM_ID, SKU_ID),
    FOREIGN KEY (ITEM_ID) REFERENCES ITEM_TABLE(ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS RESTOCKORDERITEMSRESTOCKORDER_LIST(
    ...
    RFID INTEGER,
    SKU_ID INTEGER,
    PRIMARY KEY (ID_RESTOCKORDER, ID_RESTOCKORDERITEM, RFID, SKU_ID),
...
CREATE TABLE IF NOT EXISTS SKUITEMSRESTOCKORDER_LIST(
    ...
    ID_ITEM INTEGER,
    SKU_ID INTEGER,
    PRIMARY KEY (ID_SKUITEM, ID_RESTOCKORDER, ID_ITEM, SKU_ID),
    FOREIGN KEY (ID_RESTOCKORDER) REFERENCES RESTOCKORDER_TABLE(ID) ON DELETE CASCADE ON UPDATE CASCADE
);

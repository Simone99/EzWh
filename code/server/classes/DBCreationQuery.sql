...
CREATE TABLE IF NOT EXISTS RFIDINTERNALORDERITEMS_LIST(
    ID_INTERNALORDERITEM INTEGER,
    RFID VARCHAR(32),
    PRIMARY KEY(ID_INTERNALORDERITEM,RFID),
    FOREIGN KEY(ID_INTERNALORDERITEM) REFERENCES INTERNALORDERITEM_TABLE(ID) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY(RFID) REFERENCES SKUITEM_TABLE(RFID) ON DELETE CASCADE ON UPDATE CASCADE
);

...
CREATE TABLE IF NOT EXISTS INTERNALORDER_TABLE(
    ...
    ITN INTEGER, 
    CUSTOMER INTEGER,
    FOREIGN KEY(ITN) REFERENCES INTERNALTRANSPORTNOTE_TABLE(SHIPMENTDATE) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS INTERNALORDERITEMS_LIST(
    ...
    FOREIGN KEY(ID_INTERNALORDERITEM) REFERENCES INTERNALORDERITEM_TABLE(ID) ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS RESTOCKORDERITEMSRESTOCKORDER_LIST(
    ...
    FOREIGN KEY (ID_RESTOCKORDER) REFERENCES RESTOCKORDER_TABLE(ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
